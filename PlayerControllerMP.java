...
public class PlayerControllerMP
{
    ...
    public BlockCoord getCurrentBlock()
    {
    	return new BlockCoord(currentBlockX, currentBlockY, currentblockZ);
    }
    ...
    {//TODO fix this somehow to match the old method
        return this.currentGameType.isSurvivalOrAdventure();//this.currentGameType.func_77144_e();
    }
    ...
    public boolean onPlayerDestroyBlock(int par1, int par2, int par3, int par4)
    {
        ...
        else
        {
            ...
            int blockID = var5.getBlockId(par1, par2, par3);
            ...
            else
            {
                ...
                mod_mcStats.onBreakBlock(par1, par2, par3, par4, var5, var6, var7, var8, blockID);
                ...
                if (!this.currentGameType.isCreative())
                {
                    ...
                    if (var9 != null)
                    {
                        //TODO fix this to act like old method
    ...
    public void onPlayerDamageBlock(int par1, int par2, int par3, int par4)
    {
        ...
        else
        {
            if (par1 == this.currentBlockX && par2 == this.currentBlockY && par3 == this.currentblockZ)
            {
                ...
                this.curBlockDamageMP += var6.getPlayerRelativeBlockHardness(this.mc.thePlayer, this.mc.thePlayer.worldObj, par1, par2, par3) + mod_mcStats.onDamageBlock(par1, par2, par3, par4, var5, var6);
    ...
    public boolean onPlayerRightClick(EntityPlayer par1EntityPlayer, World par2World, ItemStack par3ItemStack, int par4, int par5, int par6, int par7, Vec3 par8Vec3)
    {
        ...
        if(mod_mcStats.onRightClick(par1EntityPlayer, par2World, par3ItemStack, par4, par5, par6, par7, par8Vec3, var12, var9, var10, var11))
        	return true;
    ...
    {
        this.syncCurrentPlayItem();
        mod_mcStats.onAttack(par1EntityPlayer, par2Entity);
