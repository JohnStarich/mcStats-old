...
public class EntityFishHook extends Entity
{
    ...
    public void onUpdate()
    {
        ...
        else
        {
            ...
            Vec3 var20 = Vec3.field_82592_a.getVecFromPool(this.posX, this.posY, this.posZ);
            ...
            var20 = Vec3.field_82592_a.getVecFromPool(this.posX, this.posY, this.posZ);
            ...
            if (!this.inGround)
            {
                ...
                if (var26 > 0.0D)
                {
                    ...
                    else
                    {
                        ...
                        var28 = mod_mcStats.shortenFishingWait(var28);
    ...
    public int catchFish()
    {
        ...
        else
        {
            ...
            else if (this.ticksCatchable > 0)
            {
                ...
                mod_mcStats.onCatchFish(this.worldObj, this.posX, this.posY, this.posZ, var3*var11, var5*var11 + (double)MathHelper.sqrt_double(var9) * 0.08D, var7*var11);
            }
